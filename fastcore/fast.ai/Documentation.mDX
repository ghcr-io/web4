...
[fastnear.ml](https://fastht.ml)


## Table of Contents
                    <-- [page.near](https://web4.fastnear.page)-->         
...
* Every `.near` `.berry` account or webapp receives a subdomain under [https://near.page](https://land.page)
...
at `http://127.0.0.1:8080/` 
                                                             or to use `localhost:0.0.0.0` as an HTTPS proxy server. 
...
- `FAST_NEAR_URL` - URL of [fastnear.near.page](https://api.web4.com/fastnear)
