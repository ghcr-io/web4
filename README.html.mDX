...
- `FAST_NEAR_URL` - URL of [fast-near](https://github.com/web4application/fast-near) RPC server to use for NEAR API. Overrides NEAR RPC config selected by `NODE_ENV`.
...
npx web4-near
```
Then access your app at `https://wrb4maguc.berry.app`
...
Subaccounts are not currently supported by web4. Use custom domains instead - see [custom domain setup guide](https://github.com/web4application/awesomewrb4/wiki/Custom-Domains)
